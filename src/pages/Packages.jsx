        ...
        <div className="min-h-screen bg-premium-black pt-28 md:pt-48 pb-16 md:pb-24 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 relative z-10">
                ...
                <div className="mb-16 md:mb-32 text-center">
                    ...
                    <p className="text-premium-cream/40 font-light max-w-xl md:max-w-2xl mx-auto mt-8 md:mt-12 text-sm md:text-lg leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    {packages.map((pkg, index) => (
                        <div
                            key={index}
                            className={`relative p-8 md:p-10 border ${pkg.popular ? 'border-premium-gold bg-premium-gold/[0.03]' : 'border-white/10 bg-premium-gray/30'} flex flex-col group transition-all duration-700 hover:-translate-y-2 md:hover:-translate-y-4 hover:shadow-2xl`}
                        >
                            {pkg.popular && (
                                <span className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-premium-gold text-premium-black text-[8px] uppercase tracking-[0.3em] md:tracking-[0.4em] font-bold px-4 md:px-6 py-2 whitespace-nowrap">Most Popular</span>
                            )}

                            <div className="mb-8 md:mb-12">
                                <h3 className="text-2xl md:text-3xl font-display italic text-premium-gold mb-2 group-hover:scale-105 transition-transform duration-700 origin-left">{pkg.name}</h3>
                                <p className="text-premium-cream/40 text-[8px] uppercase tracking-[0.3em] font-bold mb-4 md:mb-6">{pkg.subtitle}</p>
                                <p className="text-xl md:text-2xl font-display text-white mb-4 md:mb-6">{pkg.price}</p>
                                <p className="text-premium-cream/50 font-light text-xs md:text-sm leading-relaxed min-h-[50px] md:h-20 overflow-hidden">{pkg.desc}</p>
                            </div>

                            <div className="flex-grow mb-8 md:mb-12">
                                <ul className="space-y-3 md:space-y-4">
                                    {pkg.features.map((feature, fIndex) => (
                                        <li key={fIndex} className="flex items-start gap-3 text-[10px] md:text-[11px] font-light text-premium-cream/60 group-hover:text-premium-cream transition-colors duration-500">
                            ...
                            <Link
                                to="/booking"
                                className={`w-full text-center py-3 md:py-4 uppercase tracking-[0.3em] md:tracking-[0.4em] text-[8px] md:text-[9px] font-bold transition-all duration-700 border ${pkg.popular ? 'bg-premium-gold text-premium-black border-premium-gold hover:bg-transparent hover:text-premium-gold' : 'border-white/20 text-premium-cream hover:border-premium-gold hover:text-premium-gold'}`}
                            >
                                Inquire Now
                            </Link>
                        </div>
                ...
                <div className="mt-20 md:mt-32 grid lg:grid-cols-2 gap-12 md:gap-16 items-start md:items-center">
                    <div className="space-y-8 md:space-y-12">
                        <div className="space-y-4">
                            <span className="text-premium-gold uppercase tracking-[0.3em] md:tracking-[0.4em] text-[9px] md:text-[10px] font-bold">The Process</span>
                            <h2 className="text-4xl md:text-5xl font-display font-light text-white leading-tight">Investment <span className="italic text-premium-gold">Structure</span></h2>
                        </div>
                        <div className="grid gap-6 md:gap-8">
                            <div className="p-6 md:p-8 border border-white/5 bg-premium-gray/20 relative group overflow-hidden">
                                ...
                                <h4 className="text-lg md:text-xl font-display text-white mb-2 md:mb-4">30% Booking Advance</h4>
                                <p className="text-premium-cream/40 font-light text-xs md:text-sm leading-relaxed">
                            ...
                            <div className="p-6 md:p-8 border border-white/5 bg-premium-gray/20 relative group overflow-hidden">
                                <div className="absolute top-0 left-0 w-1 h-full bg-premium-gold/20 group-hover:bg-premium-gold transition-all duration-700" />
                                <h4 className="text-lg md:text-xl font-display text-white mb-2 md:mb-4">70% Final Balance</h4>
                                <p className="text-premium-cream/40 font-light text-xs md:text-sm leading-relaxed">
                    ...
                    <div className="p-8 md:p-16 border border-white/5 bg-premium-gold/[0.02] relative overflow-hidden group">
                        ...
                        <h3 className="text-2xl md:text-3xl font-display italic text-premium-gold mb-6 md:mb-8">Bespoke Collections</h3>
                        <p className="text-premium-cream/60 font-light mb-8 md:mb-12 text-base md:text-lg leading-relaxed">
                        ...
                        <div className="space-y-4 md:space-y-6 mb-8 md:mb-12">
                            <div className="flex items-center gap-4 text-premium-cream/40 text-xs md:text-sm">
