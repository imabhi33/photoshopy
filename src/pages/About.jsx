        ...
        <div className="min-h-screen bg-premium-black pt-48 pb-24 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-8 lg:px-12 relative z-10">
                ...
                <div className="mb-48 text-center">
                    ...
                    <p className={`text-premium-cream/30 uppercase tracking-[0.4em] text-[10px] font-bold transition-all duration-1000 delay-500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
                        Capturing Stories, Creating Memories
                    </p>
                </div>

                {/* Story Section - Overlapping Layout */}
                <div className="grid lg:grid-cols-12 gap-24 items-center mb-64 relative">
                    <div className="lg:col-span-7 relative group">
                        ...
                        <div className="absolute -bottom-16 -right-16 w-1/2 aspect-square border border-premium-gold/10 -z-10 group-hover:border-premium-gold/30 transition-colors duration-700" />
                    </div>
                    <div className="lg:col-span-5 space-y-12 lg:-ml-32 z-10 bg-premium-black/90 backdrop-blur-md p-16 border border-white/10 shadow-2xl">
                        <h2 className="text-5xl md:text-6xl font-display italic text-premium-gold">Our Story</h2>
                        <div className="space-y-8 text-premium-cream/60 font-light leading-relaxed text-lg">
                            <p>
                        ...
                        <div className="pt-4">
                            <div className="w-24 h-[1px] bg-premium-gold/40" />
                        </div>
                    </div>
                </div>

                {/* Philosophy Section - Quote Style */}
                <div className="max-w-5xl mx-auto text-center mb-64 relative">
                    <div className="gold-line absolute -top-24 left-0" />
                    <span className="text-9xl font-display text-premium-gold/10 block mb-12">"</span>
                    <p className="text-4xl md:text-6xl font-display italic text-premium-cream leading-tight mb-12">
                        Stories are everywhere. We are searching far and wide to find them. Your wedding will have many, many stories.
                    </p>
                    <div className="w-32 h-[1px] bg-premium-gold/40 mx-auto mb-12" />
                    <p className="text-premium-gold uppercase tracking-[0.5em] text-[10px] font-bold">
                        The Philosophy of Photoshopy
                    </p>
                    <div className="gold-line absolute -bottom-24 left-0" />
                </div>

                {/* Features Grid - Minimal & Stylish */}
                <div className="grid md:grid-cols-3 gap-24 mb-64">
                    {[
                        {
                        ...
                        <div key={index} className="space-y-10 group relative">
                            <span className="text-premium-gold/10 text-8xl font-display block group-hover:text-premium-gold/30 transition-all duration-700 group-hover:-translate-y-4">{feature.icon}</span>
                            <div className="space-y-6">
                                <h3 className="text-3xl font-display text-premium-gold">{feature.title}</h3>
                                <p className="text-premium-cream/50 font-light leading-relaxed text-lg">{feature.desc}</p>
                            </div>
                ...
                <div className="relative py-32 px-16 border border-white/5 overflow-hidden group">
                    ...
                    <div className="max-w-4xl mx-auto text-center space-y-12">
                        <h2 className="text-5xl md:text-7xl font-display italic">The Storytellers</h2>
                    ...
                    <div className="absolute top-0 left-0 w-24 h-24 border-t border-l border-premium-gold/20" />
                    <div className="absolute bottom-0 right-0 w-24 h-24 border-b border-r border-premium-gold/20" />
                </div>
            </div>
        </div>
    );
